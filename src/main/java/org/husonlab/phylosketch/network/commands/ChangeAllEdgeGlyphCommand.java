 ...
 */
public class ChangeAllEdgeGlyphCommand extends UndoableRedoableCommand {
	private Runnable undo;
	private Runnable redo;

	public ChangeAllEdgeGlyphCommand(Document document, NetworkModel.EdgeGlyph oldShape, NetworkModel.EdgeGlyph newShape) {
	...
	public static void changeEdgeShape(Document document, NetworkModel.EdgeGlyph glyph) {
		ProgramProperties.put("EdgeGlyph", glyph.name());
